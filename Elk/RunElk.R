#########################
# This code sets up and runs the elk migration network metrics
# Elk data can be found in metric_inputs_calves.xlsx and metric_inputs_adults.xlsx
# CR.R does the full CR calculation and averaging.


## USERS MUST SUPPLY INPUT FILES (metric_inputs_name.xlsx) for each class
## The format of the input files is important as variables are loaded into the code based on their location in the .xlsx file
