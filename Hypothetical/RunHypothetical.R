#########################
# This code sets up and runs the hypotnetical migration network metrics
# Hypothetical data can be found in metric_inputs_<classname>.xlsx
